...
class RRTAlgorithm():
    ...
    def addChild(self, locationX, locationY):
        if (locationX == self.goal.locationX):
            ...
            newpoint = treeNode(locationX, locationY)
            #append this node to nearestNode's children
            self.nearestNode.children.append(newpoint)
            #set the parent to nearestNode
            newpoint.parent = self.nearestNode
...
# =============================================================================
grid = np.load(r'C:\Users\sachi\rrt\MotionPlanningRRTCourse\cspace.npy')
# =============================================================================
